                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" value="{{ old('name_en', $productCategory->getTranslation('name','en')) }}" class="form-control">
                            @error('name')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="name">{{ __('Name ar') }}</label>
                            <input type="text" name="name_ar" value="{{ old('name_ar', $productCategory->getTranslation('name','ar')) }}" class="form-control">
                            @error('name')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <div class="col-3">
