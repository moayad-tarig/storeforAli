                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" value="{{ old('name_en', $tag->getTranslation('name','en')) }}" class="form-control">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_ar" value="{{ old('name_ar', $tag->getTranslation('name','ar')) }}" class="form-control">
                            @error('name')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <div class="col-3">
