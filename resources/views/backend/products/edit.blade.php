        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" value="{{ old('name_en', $product->getTranslation('name','en')) }}" class="form-control">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_ar" value="{{ old('name_ar', $product->getTranslation('name','ar')) }}" class="form-control">
                            @error('name')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <div class="col-3">
                ...
                <div class="form-group pt-4">
                    <button type="submit" name="submit" class="btn btn-primary">Updat Product</button>
                </div>
            </form>
        </div>
    </div>
