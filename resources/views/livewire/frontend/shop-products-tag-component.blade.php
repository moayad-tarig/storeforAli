                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    @foreach($shop_categories_menu as $shop_category)
                        ...
                        <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                            @forelse($shop_category->appearedChildren as $sub_shop_category)
                                <li class="mb-2">
                                    <a class="reset-anchor" href="{{ route('frontend.shop', $sub_shop_category->id) }}">
                    ...
                    <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                        @forelse($shop_tags_menu as $shop_tag)
                            <li class="mb-2">
                                <a class="reset-anchor" href="{{ route('frontend.shop_tag', $shop_tag->id) }}">
                                    {{ $shop_tag->name }}
                                </a>
                            </li>
                        @empty
                            ...
                            <div class="col-4" id="products-container-area">
                                <div class="product text-center">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <a class="d-block" href="{{ route('frontend.product', $product->id) }}">
                                        ...
                                        <div class="product-overlay">
                                            <ul class="mb-0 list-inline">
                                                ...
                                                <li class="list-inline-item mr-0">
                                                    <a wire:click.prevent="$emit('showProductModalAction', '{{ $product->id }}')" class="btn btn-sm btn-outline-dark" data-target="#productView" data-toggle="modal">
                                    ...
                                    <h6><a class="reset-anchor" href="{{ route('frontend.product', $product->id) }}">{{ $product->name }}</a></h6>
