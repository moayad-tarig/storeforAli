...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $customer = User::create(['first_name' => 'Ali', 'last_name' => 'gomboz', 'username' => 'ali', 'email' => 'ali@gmail.com', 'email_verified_at' => now(), 'mobile' => '966500000002', 'password' => bcrypt('123123123'), 'status' => 1, 'remember_token' => Str::random(10)]);
